/*WAP reverse a linked list in a group of given size*/
...
void print_reverse_list(node *head, int group) //display the list in reverse order
{
    node *ptr = head;
    if (head == NULL)
    {
